// ═══════════════════════════════════════════════════════════════
// Shopify → Atica data mappers (plain JS — no build step needed)
...
function isFitName(s) { return FIT_NAMES.test(s.trim()); }
function isSizeName(s) { return SIZE_PAT.test(s.trim()); }
...
function mapSKU(product, variant) {
  return {
...
// ═══════════════════════════════════════════════════════════════
// Product Tree — builds MP → Style → Fit → Size hierarchy
//
...
function buildProductTree(product) {
