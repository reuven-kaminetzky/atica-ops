...
const TITLE_MATCHERS = {
  ...
  'white-dress':    t => (/milano/i.test(t) || /edinburgh/i.test(t) || /royal\s+oxford/i.test(t) || /firenze/i.test(t) || /tokyo.*shirt/i.test(t) || /yorkshire/i.test(t) || /boston.*(?:white|shirt)/i.test(t) || /providence.*white/i.test(t) || /open shirt.*(?:firenze|yorkshire)/i.test(t)) && !/boys/i.test(t) && !/do not use/i.test(t) && !/sneaker/i.test(t),
  ...
  'luxury-pant':    t => (/luxury.*(?:performance|fabric)\s+pants?/i.test(t) || /runway\s+pants?/i.test(t) || /shadow\s+weave\s+pants?/i.test(t) || /pant\s+separate/i.test(t)) && !/boys/i.test(t) && !/do not use/i.test(t),
