...
// Includes full names, abbreviations, and Shopify location name variants
const PATTERNS = [
  [/lakewood|^lkwd$/i,                 'Lakewood'],
  [/flatbush|brooklyn|^fb$/i,          'Flatbush'],
  [/crown\s*heights?|^ch$/i,           'Crown Heights'],
  [/monsey|spring\s*val|^mon$/i,       'Monsey'],
  [/online|web|shopify(?!_pos)|^ol$/i, 'Online'],
  [/reserve|warehouse|storage|^res$/i, 'Reserve'],
  [/wholesale|^ws$/i,                  'Wholesale'],
];
